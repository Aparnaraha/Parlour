...
const Card = ({ title, subtitle, description, icon: IconComponent }) => {
  return (
    <div className={`relative bg-neutral-800 rounded-lg p-6 transition-all duration-300 transform hover:-translate-y-1
                    ...
                    w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.33%-1.5rem)] xl:w-72`}> {/* Adjusted width for responsiveness */}
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-hidden relative z-0">
      ...
      <main className="container mx-auto py-12 px-4 text-center relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center my-8 gap-x-6 gap-y-8">
          {/* Left group of cards */}
          <div className="flex flex-wrap justify-center lg:justify-end items-stretch gap-x-6 gap-y-8 lg:w-1/2">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start items-stretch gap-x-6 gap-y-8 lg:w-1/2">
